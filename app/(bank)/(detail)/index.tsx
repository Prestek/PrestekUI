...
import { Chip, IconButton, Surface, useTheme, Divider, ActivityIndicator } from "react-native-paper";
    ...
    if (!application) {
        return (
            <View style={[styles.container, styles.centered, { backgroundColor: theme.colors.background }]}>
                <MaterialCommunityIcons name="file-search-outline" size={64} color={theme.colors.onSurfaceVariant} />
                <AppText style={[styles.emptyText, { color: theme.colors.onSurfaceVariant }]}>
