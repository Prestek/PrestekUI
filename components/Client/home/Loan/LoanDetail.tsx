    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.detailSummaryCard}>
          <AppText style={styles.detailSectionTitle}>Resumen de crédito</AppText>
          ...
          <View style={styles.detailSummaryRow}>
            <AppText style={styles.detailSummaryLabel}>Cuotas</AppText>
          ...
          <View style={styles.detailSummaryRow}>
            <AppText style={styles.detailSummaryLabelBold}>Pago mensual</AppText>
        ...
        <View style={styles.detailSummaryCard}>
          <AppText style={styles.detailSectionTitle}>Detalle de pago mensual</AppText>
          ...
          <View style={styles.detailBreakdownItem}>
            ...
            <View style={styles.detailBreakdownContent}>
              <AppText style={styles.detailBreakdownLabel}>Monto capital</AppText>
