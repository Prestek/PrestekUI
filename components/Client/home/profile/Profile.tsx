  ...
  if (!user) {
    return (
      <View style={[styles.container, localStyles.loadingContainer]}>
        ...
        />
        <AppText style={localStyles.errorText}>
    ...
    >
      ...
      >
        <View style={localStyles.cardHeader}>
          ...
          />
          <AppText
            style={[localStyles.cardTitle, { color: theme.colors.primary }]}
          >
            Información Financiera
          </AppText>
        </View>
        ...
        <View style={localStyles.infoRowSingle}>
          ...
          <AppText
            style={[
              localStyles.infoValueHighlight,
              { color: theme.colors.primary },
            ]}
          >
